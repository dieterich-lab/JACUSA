...
// CHECKED
public class DirichletMultinomialMLE extends AbstractDirMult {

	public DirichletMultinomialMLE(final BaseConfig baseConfig, final StatisticParameters parameters) {
	...
	public StatisticCalculator newInstance() {
		return new DirichletMultinomialMLE(baseConfig, parameters);
	}

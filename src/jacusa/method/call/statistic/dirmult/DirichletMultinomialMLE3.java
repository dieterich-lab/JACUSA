...
public class DirichletMultinomialMLE3 extends AbstractDirMult {

	private double estimatedError = 0.01;

	public DirichletMultinomialMLE3(final BaseConfig baseConfig, final StatisticParameters parameters) {
	...
	public String getDescription() {
		return "Dirichlet-Multinomial compound prior";
	}
	...
	@Override
	public DirichletMultinomialMLE3 newInstance() {
		return new DirichletMultinomialMLE3(baseConfig, parameters);
	}

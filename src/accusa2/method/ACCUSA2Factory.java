...
public class ACCUSA2Factory extends AbstractMethodFactory {
	...
	@Override
	public AbstractParallelPileupWorkerDispatcher<ACCUSA2_ParallelPileupWorker> getInstance(CoordinateProvider coordinateProvider, Parameters parameters) {
		if(instance == null) {
			instance = new ACCUSA2_ParallelPileupWorkerDispatcher(coordinateProvider, parameters);
		}
		return instance;
	}
